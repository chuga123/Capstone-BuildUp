...
if(isset($_POST['signin'])){
	...
	$sql = "SELECT * FROM entrep WHERE email='$email' AND password='$password'";
	...
	if(mysqli_num_rows($result) > 0) {
		...
		header ("Location: ../Small-Entrepreneur/sign-in.php?email&pass-do-not-match");
	}
}	
