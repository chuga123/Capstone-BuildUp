...
<body class="bg-smallentrep">
                            ...
                            while ($rowimg = mysqli_fetch_assoc($resultimg)) {
                                ...
                                <div class='view-product'>
                                    <div class='view-image'>
                                        ...
                                        <div class='close'>
                                            <a href='collection.php?reseller_id=".$id."&&filter=".$_GET['filter']."'><i class='fa-solid fa-xmark'></i></a>
                                        </div>
                                    </div>
                                    <div class='view-info'>
                                        ...
                                        <div class='seller'>
                                            ...
                                            <div class='info'>
                                            <p style='padding-left: 10px; font-size: 15px;'><i style='color:#00aeff;' class='fa-solid fa-envelope'></i> Email &nbsp :&nbsp".$email."</p>
                                            <p style='padding-left: 10px;font-size: 15px;'><i style='color:#2eb232;' class='fa-solid fa-phone'></i> Mobile :&nbsp0".$contact."</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>";
	...
	$(document).ready(function(){
		$('.save').on('click', function(){
			...
			$.ajax({
				url: 'view-product-collection.php',
				type: 'post',
				data: {
					'saved': 1,
					'postid': postid
