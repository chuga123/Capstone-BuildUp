...
if(isset($_SESSION['reseller_id'])){
    header("location:../Reseller/home.php?reseller_id=".$_SESSION['reseller_id']."&&filter=All&&sign out first");
}
?>
            ...
            <div class="sign-left">
                <div class="sign-pad">
                    <form method="POST" onkeydown="return event.key != 'Enter';">
                        ...
                        <button type="submit" name="signin" formaction="../Reseller/sign-in-process.php" id="signinBtn" style="display:none">Sign In</button>
                    </form>
                </div>
            </div>
